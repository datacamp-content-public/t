...
- [ ] Add the datasets (preferably as CSV files) for your course in the Teach Editor. Also include the `.sql` file to specify creation of your tables. Check with your CL if any clarity is needed.
